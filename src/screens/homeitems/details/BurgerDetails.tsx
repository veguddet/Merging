        ...
        <View>
          ...
          <View
            ...
            <Text style={style.nutritionsText}>
              {Route.carbs} {isPatty ? '+ 10' : ''} {isveggies ? '+ 10' : ''}{' '}
              {checCheese ? '+ 10' : ''}{' '}
            ...
            <Text style={style.nutritionsText}>
              {Route.proteins} {isPatty ? '+ 10' : ''} {isveggies ? '+ 10' : ''}{' '}
              {checCheese ? '+ 10' : ''}{' '}
              {checCheese || isveggies || isPatty ? (
            ...
            <Text style={style.nutritionsText}>
              {Route.fats} {isPatty ? '+ 10' : ''} {isveggies ? '+ 10' : ''}{' '}
              {checCheese ? '+ 10' : ''}{' '}
              {checCheese || isveggies || isPatty ? (
                <Text>= {fats} g</Text>
              ) : (
            ...
            <View
              ...
              <TouchableOpacity
                onPress={() =>
                  Alert.alert(
                    'per 25 grams',
                    'Carbs : 20  Protines : 30  Fat : 26 /n Total Calories',
                    [
                      {
                        text: 'Ok',
                      },
